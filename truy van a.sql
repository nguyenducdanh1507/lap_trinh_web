1. a. Lấy ra danh sách người dùng theo thứ tự tên theo Alphabet (A->Z)					
 SELECT * FROM users ORDER BY user_name ASC;				
 1.b. Lấy ra 07 người dùng theo thứ tự tên theo Alphabet (A->Z)		
SELECT * FROM users ORDER BY user_name ASC LIMIT 7;					
1.c. 3.Lấy ra danh sách người dùng theo thứ tự tên theo Alphabet (A->Z), trong đó tên người dùng có chữ a								
 SELECT * FROM users WHERE user_name LIKE '%a%' ORDER BY user_name ASC						 
 1.c.4Lấy ra danh sách người dùng trong đó tên người dùng bắt đầu bằng c
 SELECT * FROM users WHERE user_name LIKE 'm%';	
 5. Lấy ra danh sách người dùng trong đó tên người dùng kết thúc bằng chữ 
